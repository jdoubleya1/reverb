  ...
  var ECHO = {
    ...
    utils: {
      ...
      preloader: function () {
        ...
        if (
          $('.site-header .navbar-brand').length > 0 &&
          $('.site-header .navbar-nav .nav-link').length > 0 &&
          $('.site-header .btn').length > 0
        ) {
          gsap.from(
            [
      ...
      devTools: function () {
        ...
        $('body').append(
          '<div id="devTools" class="text-uppercase fs-xs"></div>',
        )
        ...
        $(window).on('scroll resize load', function () {
          if ($(window).scrollTop() > $header_height) {
            ...
            if ($stickybgcolor) {
              ...
              $nav.attr(
                'style',
                'background-color:' + $stickybgcolor + '!important',
              )
            }
      ...
      blockFeaturesImage: function () {
        if ($('.features_with_photo_2').length > 0) {
          ...
          t.find('.swiper')
            ...
            .prepend(
              '<div class="row swiper-pagination position-relative"></div><div class="swiper-scrollbar position-relative mb-5"></div>',
            )
          ...
          var gallery = new Swiper('.features_with_photo_2 .swiper', {
            ...
            pagination: {
              ...
              renderBullet: function (index, className) {
                ...
                return (
                  '<div class="col d-flex align-items-center justify-content-start py-4 bg-transparent text-uppercase">' +
                  (icon
        ...
        if ($('.features_with_photo_7').length > 0) {
          ...
          var galleryThumbs = new Swiper(
            '.features_with_photo_7 .gallery-thumbs',
            {
              spaceBetween: 10,
              slidesPerView: 4,
              loop: true,
      ...
      blockGrid: function () {
        ...
        if ($('.grid_11').length > 0 && ECHO.vals.winWidth < ECHO.vals.lg) {
          ...
          $(window).on('load', function () {
            var swiper = new Swiper('.grid_11 .swiper', {
              spaceBetween: 15,
              loop: true,
              slidesPerView: 'auto',
              loop: true,
