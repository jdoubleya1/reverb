 ...
 *     2. Concatenates all the files and generates wp-admin.js
 *     3. Renames the JS file with suffix .min.js
 *     4. Uglifes/Minifies the JS file and generates wp-admin.min.js
 */
gulp.task('adminJS', () => {
  return gulp
...
//       ),
//     )
//     .pipe(gulp.dest(config.adminImgDST))
//     .pipe(
//       notify({
//         message: '\n\n✅  ===> ADMIN IMAGES — completed!\n',
//         onLast: true,
//       }),
//     )
// })
...
gulp.task(
  ...
  gulp.parallel(
    ...
    () => {
      ...
      gulp.watch(config.watchAdminStyles, gulp.series('adminStyles')) // Reload on admin SCSS file changes.
      ...
      //   gulp.watch(config.adminImgSRC, gulp.series('adminImages', reload)) // Reload on customJS file changes.
    },
  ),
)
